...
public class Tree_Reservations {
    ...
    /**
     * Constructor de la clase Tree_Reservations
     */
     ...
     * @param reservation Nodo nuevo a insertar.
     */
    ...
    /**
     * Este método encuentra un nodo dado un key.
     * @param id Key del nodo que se desea encontrar.
     * @param nodo Nodo raíz del Arbol para poder recorrerlo.
     * @return Retorna el nodo encontrado por medio de la key.
     */
    ...
    /**
     * Método para validar si el arbol está vacío.
     * @return retorna true si el arbol no tiene nodos.
     */
